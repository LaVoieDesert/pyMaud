...
#   0.090276055(0.004326386) #autotrace #positive #min 0.0 #max 1.0
def parse_single_maud_value_nokeyword(ligne):
    return v_all_nokeyword.parseString(ligne)

def get_value(data):
    return float(data['v_value']['value'])
...
if __name__ == "__main__":
    ...
    print(parse_single_maud_value_nokeyword("0.090276055(0.004326386) #autotrace #positive #min 0.0 #max 1.0"))
